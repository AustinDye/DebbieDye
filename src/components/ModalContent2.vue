  ...
  <div class="container">
    <div class="row backsplash">
      <div class="hold-2 mb-5">
        <h2 class="p-2">Pre-listing to Close</h2>
      </div>
      ...
      <div class="col-md-5">
        <div class="section section-1">
          <p>
            <span>1.</span>Review listing documents for accuracy and signatures
          </p>

          <p><span>2.</span>Transfer file from Instanet to Paragon</p>
      ...
      <div class="col-md-5">
        <div class="section section-2">
          <p>
            <span>3.</span>Enter listing details in transaction management
            system (TMS)
          </p>
          <p><span>4.</span> Upload listing docs to TMS</p>
      ...
      <div class="col-md-5">
        <div class="section section-4">
          <p><span>7.</span>Post LIVE in MLS-Agent or TC</p>

          <p>
            <span>8.</span> Enter Lockbox#/Shackle code and assign it to the
            listing
          </p>
